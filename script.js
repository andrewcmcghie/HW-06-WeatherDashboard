...
// This function should display the city when the user enters it //
...
// This function pulls the cities list array from the local storage functions created earlier //
...
// This function takes the current city into local storage and displays the fiveday forecast //
...
// This function stores the cities array to local storage //
function storeCityArray() {
    localStorage.setItem("cities", JSON.stringify(cityList));
    }

// This function stores the current city to local storage //
...
// This function runs the Open Weather API AJAX call//
async function displayWeather() {

    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=b3400898ed71f40f8c387b0835654d21";
    ...
    var response = await $.ajax({
        ...
        //defining responses for console//
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=b3400898ed71f40f8c387b0835654d21&lat="+getLat+"&lon="+getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=b3400898ed71f40f8c387b0835654d21";
